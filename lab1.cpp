...
} g; 				//make the class above global, by using g.xres, g.yres, etc. 'g.' in front of global variable
...
} x11;	//member of the x11 class instantiated here
